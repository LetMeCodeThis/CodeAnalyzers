namespace Analyzers.Core
{
    ...
    /// <summary>
    /// Copy & paste from https://github.com/dotnet/roslyn/blob/03e30451ce7eb518e364b5806c524623424103e4/src/Workspaces/CSharp/Portable/Utilities/TokenComparer.cs
    /// Changed class visibility to public
    /// </summary>
    public class TokenComparer : IComparer<SyntaxToken>
    {
        ...
        private static bool IsSystem(string s) => s == SystemNamespace;

        public int Compare(SyntaxToken x, SyntaxToken y)
        {
            if (this.specialCaseSystem &&
